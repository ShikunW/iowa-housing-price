...
train = fread("/Users/shikunwang/Desktop/STATS503/final project/train.csv", stringsAsFactors = F)
test  = fread("/Users/shikunwang/Desktop/STATS503/final project/test.csv", stringsAsFactors = F)
